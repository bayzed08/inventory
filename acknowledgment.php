            ...
            <div class="container-fluid text-center">
                <div class="row content">
                    ...
                    <div class="col-sm-12 text-left">
                        ...
                        <div id="Dreportshow" style="background-color:#ccd0d4;padding:10px;border-radius:10px;box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
                            <form id="ackDataform" name="ackDataform">
                                <div class="form-group" style="width:100%;">
                                    ...
                                    <div class="form-group row">
                                        <label for="brandSearch" class="col-sm-2 col-form-label" style="padding:5px;text-align:right;">ব্র্যান্ডঃ</label>
                                        <div class="col-sm-6">
                                            <input type="text" name="brandSearch" id="brandSearch" class="form-control" placeholder="Brand Name" autocomplete="off">
                                            <div id="resultbrandSearch"></div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="remarks" class="col-sm-2 col-form-label" style="padding:4px;text-align:right;">মন্তব্যঃ</label>
                                        <div class="col-sm-6">
                                            <input type="text" name="remarks" id="remarks" class="form-control" placeholder="Remarks">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="transferdate" class="col-sm-2 col-form-label" style="padding:4px;text-align:right;">হস্তান্তর তারিখঃ</label>
                                        <div class="col-sm-6">
                                            <input type="date" name="transferdate" id="transferdate" class="form-control" value="<?php echo date("Y-m-d"); ?>">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group row">
                        ...
                        padding:10px;border-radius:15px;box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
                           ...
                           FROM acknowledgetab aa,cashvoucher_info cc
                            ...
                            echo "<tr style='font-size:16px;padding:10px;'>
                                         ...
                                         <th style='width:25;border:1px solid black;text-align:center;'>Model</th>
                            ...
                            while ($row555 = $result555->fetch_assoc()) :
                                ...
                                echo "<tr style='font-size:13px;font-family:Tahoma;padding:2px;'>
                                         ...
                                         <td style='border:1px solid black;text-align:left;padding-left:5px'>" . $row555['model'] . "</td>
